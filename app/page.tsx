...
export default function Home() {
  ...
  const [form, setForm] = useState<BookingForm>({ menuItems: [], date: "2026-07-12", startTime: DEFAULT_START_TIME, people: 2, name: "", email: "", phone: "", address: "", accountType: "individual", bookingType: "individual", paymentCondition: defaultPaymentCondition, remarks: "", status: STATUS.confirmedRequested });
  ...
  const [adminForm, setAdminForm] = useState<BookingForm>({ menuItems: [], date: "2026-07-12", startTime: DEFAULT_START_TIME, people: 2, name: "", email: "", phone: "", address: "", accountType: "individual", bookingType: "individual", paymentCondition: defaultPaymentCondition, remarks: "", status: STATUS.confirmed });
  ...
  const submitAdminReservation = async () => {
    try {
      ...
      setAdminForm({ menuItems: [], date: "2026-07-12", startTime: DEFAULT_START_TIME, people: 2, name: "", email: "", phone: "", address: "", accountType: "individual", bookingType: "individual", paymentCondition: defaultPaymentCondition, remarks: "", status: STATUS.confirmed });
