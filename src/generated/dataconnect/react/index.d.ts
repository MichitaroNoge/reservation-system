...
export function useUpdateReceiptEmailDelivery(options?: useDataConnectMutationOptions<UpdateReceiptEmailDeliveryData, FirebaseError, UpdateReceiptEmailDeliveryVariables>): UseDataConnectMutationResult<UpdateReceiptEmailDeliveryData, UpdateReceiptEmailDeliveryVariables>;
export function useUpdateReceiptEmailDelivery(dc: DataConnect, options?: useDataConnectMutationOptions<UpdateReceiptEmailDeliveryData, FirebaseError, UpdateReceiptEmailDeliveryVariables>): UseDataConnectMutationResult<UpdateReceiptEmailDeliveryData, UpdateReceiptEmailDeliveryVariables>;

export function useCreateApprovalEmailDelivery(options?: useDataConnectMutationOptions<CreateApprovalEmailDeliveryData, FirebaseError, CreateApprovalEmailDeliveryVariables>): UseDataConnectMutationResult<CreateApprovalEmailDeliveryData, CreateApprovalEmailDeliveryVariables>;
export function useCreateApprovalEmailDelivery(dc: DataConnect, options?: useDataConnectMutationOptions<CreateApprovalEmailDeliveryData, FirebaseError, CreateApprovalEmailDeliveryVariables>): UseDataConnectMutationResult<CreateApprovalEmailDeliveryData, CreateApprovalEmailDeliveryVariables>;

export function useUpdateApprovalEmailDelivery(options?: useDataConnectMutationOptions<UpdateApprovalEmailDeliveryData, FirebaseError, UpdateApprovalEmailDeliveryVariables>): UseDataConnectMutationResult<UpdateApprovalEmailDeliveryData, UpdateApprovalEmailDeliveryVariables>;
export function useUpdateApprovalEmailDelivery(dc: DataConnect, options?: useDataConnectMutationOptions<UpdateApprovalEmailDeliveryData, FirebaseError, UpdateApprovalEmailDeliveryVariables>): UseDataConnectMutationResult<UpdateApprovalEmailDeliveryData, UpdateApprovalEmailDeliveryVariables>;
...
export function useListApprovalEmailDeliveries(options?: useDataConnectQueryOptions<ListApprovalEmailDeliveriesData>): UseDataConnectQueryResult<ListApprovalEmailDeliveriesData, undefined>;
export function useListApprovalEmailDeliveries(dc: DataConnect, options?: useDataConnectQueryOptions<ListApprovalEmailDeliveriesData>): UseDataConnectQueryResult<ListApprovalEmailDeliveriesData, undefined>;
